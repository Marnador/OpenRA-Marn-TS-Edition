...
GForce = { "e1", "e1", "e1", "e1", "e2", "medic", "e1", "e2", "e2", "e1" }
...
SetupInvulnerability = function()
   for i, actor in ipairs(Map.NamedActors) do
...
SendNodInfantry = function()
    ...
    Trigger.AfterDelay(DateTime.Seconds(30), SendNodInfantry)
end
...
SendNodVehicles = function()
    ...
    Trigger.AfterDelay(DateTime.Seconds(70), SendNodVehicles)
end
...
SendGDIInfantry = function()
    ...
    Trigger.AfterDelay(DateTime.Seconds(30), SendGDIInfantry)
end
